...
<?php			
			if( $_POST['acao']=='excluir'){				
				$sql    = 'delete  FROM produtos where codigo='.$_POST["codigo"];
				//echo $sql;
				mysql_query($sql, $link);				
			}
			else if( $_POST['acao']=='alterar'){
				$sql    = "update produtos set nome='".$_POST["nome"]."',categoria=".$_POST["categoria"].",descricao='".$_POST["descricao"]."' where (codigo=".$_POST["codigo"].");";
				//echo $sql;
				mysql_query($sql, $link);							
			}
